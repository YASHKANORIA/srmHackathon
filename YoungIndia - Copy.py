...
notification = tk.Label(root, text="Notification : ",width=12  ,height=1,fg="black",bg="white" ,font=('times', 15, ' bold ') )
notification.place(x=390, y=450)

message = tk.Label(root, text=" ",width=30  ,height=1,fg="black",font=('times', 15, ' bold ') )
message.place(x=580, y=450)
